          ...
          <table class="table text-nowrap mb-0 align-middle table-striped">
            ...
            <tbody>
              ...
              if ($res) {
                ...
                ?>
                  <tr>
                    ...
                    <td class="border-bottom-0">
                      <p class="mb-0 fw-normal"><?php echo $row['address']; ?></p>
                    </td>
                    <td class="border-bottom-0">
                      <p class="mb-0 fw-normal"><?php echo $row['coordinates']; ?></p>
                    </td>
                    <td class="border-bottom-0">
                        <a href="?del&hospitalID=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
                    </td>
                  </tr> 
              ...
              <?php
                if (isset($_GET['del'])) {
                    $id = $_GET['hospitalID'];
                    $sql = "DELETE FROM `_hospitals` WHERE id=$id";
                    $res = $db->exec($sql);
                    if ($res) {
                        ?>
                            <script>
